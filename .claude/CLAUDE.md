...
4. Read the project's own `CLAUDE.md` / `README.md` before working in it — patterns differ per project (e.g., `WpfOnnxWinUI3Demo` requires Visual Studio MSBuild, not `dotnet build`)
