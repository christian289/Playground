...
local suites = { "test_csv", "test_grid", "test_sandbox", "test_battle", "test_data", "test_editor", "test_progress", "test_tutorial", "test_particles", "test_cutscene", "test_stageinfo", "test_demolish", "test_stars", "test_abilities" }
local pass, fail = 0, 0
